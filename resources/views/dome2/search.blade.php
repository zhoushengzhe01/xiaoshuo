...
<div class="main w">
	...
	<a href="{{$website->site}}">首页</a><span class="jiantou"><img src="{{$website->public}}/images/jiantou.png" alt="小说最近更新"></span>小说搜索 </div>
    <div class="jilu">
        <ul class="t">
            <li class="s1">小说名</li>
            <li class="s2">最新章节</li>
    	...
    	<div id="banner">
            <ul>
                ...
                <li class="s1"><a href="{{$website->site}}/book/{{$val->id}}">{{$val->title}}</a></li>
                <li class="s2"><a href="{{$website->site}}/book/{{$val->id}}/{{$val->new_catalog_id}}" target="_blank">{{$val->new_catalog_title}}</a></li>
